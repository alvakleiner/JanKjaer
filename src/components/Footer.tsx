...
function Footer() {
    ...
    const content = {
        press: { no: "Pressemateriale", en: "Press material" },
        developer: { no: "Nettside utviklet av", en: "Website developed by" }
    }
        ...
        <footer className="relative bg-neutral-900 text-neutral-100 overflow-hidden">
            ...
            <div className="relative">
                ...
                <div className="relative z-10">
                    ...
                    © {new Date().getFullYear()} Jan Kjærstad · {content.developer[lang]} Alva Kjærstad Leiner
                    </div>
                </div>
            </div>
        </footer>
