...
const tegnTilKjaerlighetContent: BookPageContent = {
  ...
  meta: { no: "Roman (2002)", en: "Novel (2002)" },
  buyLink: {
    no: { label: "Kjøp boken her", href: "https://aschehoug.no/tegn-til-kjaerlighet" },
    en: { label: "Buy the book here", href: "https://aschehoug.no/tegn-til-kjaerlighet" },
  },
  coverImage: {
  ...
  quotes: [
    {
      ...
      source: "Fanny Söderbäck, Sydsvenskan",
    },
    {
      text: "«Nok en gang har Jan Kjærstad gitt oss en flott, inspirerende fortelling – han har skapt tegn til ettertanke.»",
      source: "Lillian Vatnøy, Dagsavisen",
    },
    {
      text: "«… en betagende roman om den store kærligheden fortalt i et snart klaustrofobisk, snart svævende, på én gang enkelt og ornamenteret sprog.»",
      source: "Mie Lund, Berlingske Tidende, København",
    },
  ],
  paragraphs: {
    no: [
