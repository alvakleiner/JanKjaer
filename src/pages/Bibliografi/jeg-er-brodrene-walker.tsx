...
const jegErBrodreneWalkerContent: BookPageContent = {
  ...
  meta: { no: "Roman (2008)", en: "Novel (2008)" },
  buyLink: {
    no: { label: "Kjøp boken her", href: "https://aschehoug.no/jeg-er-brodrene-walker-3" },
    en: { label: "Buy the book here", href: "https://aschehoug.no/jeg-er-brodrene-walker-3" },
  },
  coverImage: {
  ...
  paragraphs: {
    ...
    en: [
      ...
      "Oslo, 1984: Odd Marius Walaker is 14 years old, and nothing is impossible anymore. He has an erotic relationship to the lady next door. He is attacked by four girls wanting to circumcise him. He sends teachers to see the headmaster. He has long conversations with Ancient Greece, his history teacher. He answers people's love letters in a magazine. He speculates on the identity of the person terrorizing the city with book bombs. He has a strong wish to save his parents' marriage, and he tries to assist when his best friend's little brother is reported missing.",
