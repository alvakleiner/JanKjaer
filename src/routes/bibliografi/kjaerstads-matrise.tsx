...
export const Route = createFileRoute("/bibliografi/kjaerstads-matrise")({
  component: kjærstadsMatrise,
});
    ...
    <section className="bg-white">
      ...
      "
        ...
        "
          >
            {lang === "no"
              ? "I forbindelse med utgivelsen av boken, publiserte Dagbladet et interju med forfatteren, "
              : "In connection with the publication of the book, Dagbladet published an interview with the author, "}
            <a
              href="https://www.dagbladet.no/tekstarkiv/artikkel.php?id=5001070086712&tag=EMNEORD&words=PERSONALIA"
              target="_blank"
              rel="noreferrer"
