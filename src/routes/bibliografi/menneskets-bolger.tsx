...
export const Route = createFileRoute("/bibliografi/menneskets-bolger")({
  component: MennesketsBolger,
});
...
const mennesketsBolgerContent: BookPageContent = {
  ...
  buyLink: {
    no: {
      ...
      href: "https://aschehoug.no/menneskets-bolger-essays-artikler-tekster",
    },
    en: {
  ...
  quotes: [
    ...
    },
    {
      text: (
        <>
          «Jan Kjærstad kaster et interessant lys på dagens tidsånd. I sin nye essaysamling{" "}
          <em>Menneskets bølger</em> skriver Jan Kjærstad om litterære forbilder, skjulte perler,
          norsk kulturpolitikk, egen skriveprosess og mye annet. Men uansett hvilket tema han
          belyser, så kommer hans kjærlighet til det skrevne ord klart fram.»
        </>
      ),
